...
static func ui(key: String) -> String:
	var table := {
		...
		"pause_title":      {"fr": "PAUSE", "en": "PAUSED", "id": "JEDA"},
		"pause_resume":     {"fr": "REPRENDRE", "en": "RESUME", "id": "LANJUTKAN"},
		"pause_quit":       {"fr": "QUITTER AU MENU", "en": "QUIT TO MENU", "id": "KEMBALI KE MENU"},
